...
##So we use the type = "l" argument to construct the line. I find this more handy
##as the line argument in a blank plot makes colouring the line a little difficult.
